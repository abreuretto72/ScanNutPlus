...
# Let's replace the entire build method with a known-good structure
    ...
    if (_appointments.isEmpty) {
      return Center(
        child: Column(
          ...
          children: [
            Icon(Icons.event_busy_rounded, size: 60, color: Colors.black.withValues(alpha: 0.3)),
            const SizedBox(height: 16),
            Text(l10n.pet_appointment_empty_history, style: const TextStyle(color: Colors.black54, fontSize: 16, fontWeight: FontWeight.w600)),
...
print("Build method replaced completely!")
